...
BOT_TOKEN = getenv("BOT_TOKEN","6701671043:AAEPsPbKfftR4TqDA3yJ8WDFV3iJ9xOXuSY")
MONGO_DB_URI = getenv("MONGO_DB_URI", "")
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "9999"))
LOGGER_ID = int(getenv("LOGGER_ID", "-1002229770033"))
BOTADDLOGS = int(getenv("BOTADDLOGS", "-1002229770033")) # LOGGER_ID Id Also Use No Problem
GBAN_LOGS = int(getenv("GBAN_LOGS", "-1002229770033"))
GCAST_USERS = list(map(int, getenv("GCAST_USERS").split()))
OWNER_ID = int(getenv("OWNER_ID", 6180148187))
OWNER = int(getenv("OWNER", 6180148187))
OWNER_USERNAME = getenv("OWNER_USERNAME","SanjayS27")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/traintiming/stationanie")
